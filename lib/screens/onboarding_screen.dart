  ...
  Future<void> _saveProfile() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (healthState is ProfileDataExtracted && healthState.profile != null) {
          // Use existing profile data if available
          profile = healthState.profile.copyWith(name: name, email: email);
        } else {
          // Create a new profile if no extracted data
